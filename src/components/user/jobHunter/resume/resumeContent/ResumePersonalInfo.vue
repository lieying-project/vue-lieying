                ...
                <div class="info-flex-item">
                    ...
                    <span class="name"
                        ...
                        <svg id="icon_man" class="icon-man" viewBox="0 0 1024 1024" >
                            <path d="M64 512a448 448 0 1 0 896 0 448 448 0 1 0-896 0z" fill="#4BA1F1" v-if="resume.jobHunter.sex=='男'"></path>
                            <path d="M64 512a448 448 0 1 0 896 0 448 448 0 1 0-896 0z" fill="#FF9DC6" v-if="resume.jobHunter.sex=='女'"></path>
                    ...
                    <p>
                        ...
                        <span class="prev-line">
                                ...
                                {{resume.jobHunter.education}}</span>
                        <Vdot/>
                        |
                        <Vdot/>
                        <span class="prev-line">
                    ...
                    <img src="../../../../../assets/imgs/phone.png">{{resume.jobHunter.phone}}
                    </span></p>
                </div>
                <div class="info-flex-photo-wrapper">
                    <el-avatar :size="80" :src="resume.jobHunter.photo"></el-avatar>
            ...
            <div class="personal-info-form" :style="{display:isShowPersonalInfoForm==true?'flex':'none'}">
                ...
                <div class="form-item">
                    ...
                    <el-input placeholder="电话"  :disabled="false"
                              v-if="resume.jobHunter!=null" disabled="true"/>
                </div>
                <div class="form-item">
                    <div class="item-label">
                        所在地
                    ...
                    <el-input placeholder="所在地" v-model="resume.jobHunter.address" :disabled="false"
                ...
                <div class="form-item">
                    ...
                    <el-input placeholder="邮箱 " v-model="resume.jobHunter.email" v-if="resume.jobHunter!=null"/>
                </div>
                ...
                <div class="form-item">
                    ...
                    <el-input placeholder="兴趣" v-model="resume.jobHunter.interest" v-if="resume.jobHunter!=null"/>
                </div>
                <div class="form-item">
                    <div class="op">
  ...
  methods: {
    ...
    handleBeforeUpload (file) {
      ...
      axios({
        ...
        this.resume.jobHunter.photo=data.data
        this.$store.dispatch('updateJobHunterAction',this.jobHunter)
      })
    },
    // 文件超出个数限制时的钩子
